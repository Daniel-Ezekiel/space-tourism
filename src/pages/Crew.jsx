    ...
    <div className='min-h-[100vh] p-4 bg-crew-mobile bg-cover text-white md:bg-crew-tablet md:pt-[0] md:pr-[0] md:pb-[0] xl:bg-crew-desktop'>
      ...
      <main className='py-4 grid gap-8 md:mt-10 md:px-6 md:pl-4 xl:grid-cols-2 md:pb-[0] xl:w-[120rem] xl:mx-auto'>
        <motion.h1
          ...
          className='font-tagline text-lg text-center text-white uppercase tracking-widest md:text-[2rem] md:text-left xl:col-span-full xl:text-[2.8rem]'
        >
        ...
        <motion.section
          ...
          initial='hidden'
          whileInView='unhidden'
          className='w-[30rem] mx-auto grid gap-5 md:w-[57.5rem] md:grid-cols-2 md:row-start-2 xl:col-start-1 xl:self-center'
        >
